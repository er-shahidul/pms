 ...
 * @ORM\Entity(repositoryClass="Pms\PettyCashBundle\Entity\Repository\TransactionRepository")
...
class Transaction
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Pms\UserBundle\Entity\User")
     * @ORM\JoinColumn(name="transact_to", nullable=true)
     */
    private $transactTo;
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="Pms\PettyCashBundle\Entity\TransactionHistory", mappedBy="transaction", cascade={"persist", "remove"})
     */
    ...
    /**
     * @return \Pms\PettyCashBundle\Entity\User
     */
    ...
    /**
     * @param \Pms\PettyCashBundle\Entity\User $createdBy
     */
    ...
    /**
     * @return \Pms\UserBundle\Entity\User
     */
    public function getTransactTo()
    {
        return $this->transactTo;
    }

    /**
     * @param \Pms\UserBundle\Entity\User $transactTo
     */
    public function setTransactTo($transactTo)
    {
    ...
    /**
     * @param ArrayCollection $transactionHistory
     */
