...
/**
 * PurchaseRequisitionItemCloseInfoRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class PurchaseRequisitionItemCloseInfoRepository extends EntityRepository
{
    ...
    public function getPurchaseRequisitionIndividualData($data)
    {
        ...
        $query->leftJoin('pric.purchaseRequisitionItem','pri');
