var Index = function () {
    ...
    return {
        ...
        initCharts1: function () {
            ...
            if ($('#site_statistics_bd').size() != 0) {

                $('#site_statistics_loading1').hide();
                $('#site_statistics_content1').show();

                var plot_statistics = $.plot($("#site_statistics_bd"), [{
                    data: pageviews,
                    label: "Unique Visits"
                }, {
                    data: visitors,
                ...
                $("#site_statistics_bd").bind("plothover", function (event, pos, item) {
            ...
            if ($('#site_statistics_bd').size() != 0) {
                ...
                var plot_statistics = $.plot($("#site_statistics_bd"), [getRandomData()], {
                    series: {
                        shadowSize: 1
                    },
                    lines: {
                ...
                $('#site_statistics_bd').bind("mouseleave", function () {
                    $("#tooltip").remove();
                });
            }
        ...
        initChartsBudgets: function (PrData) {
            ...
            function showTooltip(x, y, countPr, createdDate) {
                $('<div id="tooltip" class="chart-tooltip">' +
                    '<div class="date">' +  createdDate + '<\/div>' +
                    '<div class="label label-success">Budget: ' + countPr + ' tk<\/div>' +
                    '').css({
                        position: 'absolute',
                        display: 'none',
                        top: y - 70,
            ...
            if ($('#site_statistics_bd').size() != 0) {
                ...
                $('#site_statistics_loading_bd').hide();
                $('#site_statistics_content_bd').show();
        ...
        initChartsBudgetsProject: function (PrData) {
            ...
            if ($('#site_statistics_bd_project').size() != 0) {

                $('#site_statistics_loading_bd_project').hide();
                $('#site_statistics_content_bd_project').show();

                var plot_statistics = $.plot($("#site_statistics_bd_project"), [
                    {
                        data: visitors,
                        label: "Project"
                    },
                ...
                var previousPoint = null;
                $("#site_statistics_bd_project").bind("plothover", function (event, pos, item) {
                    $("#x").text(pos.x.toFixed(2));
                    $("#y").text(pos.y.toFixed(2));
                    if (item) {
                        if (previousPoint != item.dataIndex) {
